			...
			(function(e, t, n) {
				...
				function d(e, t) {
					for (var n = [], r = "", a = [
						...
						l += l < 7936 ? 33088 : 49472, n.push(l >> 8, l & 255), r += String.fromCharCode(i.shiftJISTable[l]);
					}
					return {
						bytes: n,
						text: r
...
})), R = /* @__PURE__ */ c(I()), z = /* @__PURE__ */ c(L()), B = R.default, V = z.default;
export { B as QRCode, V as jsQR };
